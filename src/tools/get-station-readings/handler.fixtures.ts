import type { StationReadingLatestRaw } from './handler.js';
...
// carries an `attribution` field — never observed live (see handler.ts), but the shape here
// is illustrative/hypothetical for exercising the passthrough path.
