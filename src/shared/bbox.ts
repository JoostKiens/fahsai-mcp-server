...
export function radiusKmToBbox(lat: number, lng: number, radiusKm: number): BoundingBox {
...
export function clampToDataBbox(bbox: BoundingBox, dataBbox: BoundingBox): BoundingBox | null {
